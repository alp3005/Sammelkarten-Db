...
public class SuchenZauber {
	...
	static Card[] FibonacciSearchZauber(Spell[] spells, int i, int length, int at, String atString) {
		// TODO Auto-generated method stub
		return null;
	}

	static Card[] ExponentialSearchZauber(Spell[] spells, int i, int length, int at, String atString) {
		// TODO Auto-generated method stub
		return null;
	}

	static Card[] InterpolationSearchZauber(Spell[] spells, int i, int length, int at, String atString) {
		// TODO Auto-generated method stub
		return null;
	}
