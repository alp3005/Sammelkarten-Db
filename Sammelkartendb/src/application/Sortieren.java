...
public class Sortieren {
	...
	public static Card[] sort(Card[] cards, int m, int at, boolean down) {
		...
		Card[] temp = spells; //nicht ganz sicher, ob diese drei Arrays nˆtig sind, aber ich lasse sie lieber, damit die L‰ngen sicher stimmen
		Card[] temp2 = traps;
		Card[] temp3 = monsters;
		switch(m) {
		case 1: //Mergesort
			...
			case 2: //Typ
				...
				//Alle Karten wieder in ein einzelnes Array ¸berf¸hren
